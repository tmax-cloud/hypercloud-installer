...
export default class TektonTriggerInstaller extends AbstractInstaller {
  ...
  public static readonly INSTALL_HOME = `${Env.INSTALL_ROOT}/${TektonTriggerInstaller.DIR}`;

  public static readonly IMAGE_HOME = `${TektonTriggerInstaller.INSTALL_HOME}/image`;
  ...
  protected async sendImageFile() {
    ...
    const srcPath = `${Env.LOCAL_INSTALL_ROOT}/${TektonTriggerInstaller.DIR}/`;
    await scp.sendFile(
      mainMaster,
      srcPath,
