...
export default class IngressControllerSystemInstaller extends AbstractInstaller {
  ...
  public static readonly INSTALL_HOME = `${Env.INSTALL_ROOT}/${IngressControllerSystemInstaller.DIR}`;

  public static readonly IMAGE_HOME = `${IngressControllerSystemInstaller.INSTALL_HOME}/image`;
  ...
  protected async sendImageFile() {
    ...
    const srcPath = `${Env.LOCAL_INSTALL_ROOT}/${IngressControllerSystemInstaller.DIR}/`;
    await scp.sendFile(
      mainMaster,
      srcPath,
